...
function GridCard({ClassName, supTitle, title, description, image, rounded}) {
    ...
    return image && (
        <div className={`rounded-xl h-[500px] ${ClassName}  bg-cover flex justify-bottom items-end border border-slate-300`}
         ...
         >
            <div className={`bg-white backdrop-blur-md  border border-white/50 shadow-lgbg-slate-800 h-[30%]  space-y-1 w-full rounded-b-xl flex flex-col justify-center pt-24 pb-24 p-8 ${rounded}`}>
