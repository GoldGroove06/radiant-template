    ...
    <div>
      ...
      <section className='h-full w-full bg-violet-1000 rounded-3xl mt-32  flex flex-row justify-center p-6'>
        ...
        <div className='grid lg:grid-cols-6 grid-rows-2 gap-4 mt-8'>
          <GridCard2 ClassName='col-span-4 lg:rounded-tl-3xl' supTitle="Sales" title="Sales" description="Sales" image={"/images/app.png"}/>
          <GridCard2 ClassName='lg:col-span-2 col-span-4 lg:rounded-tr-3xl' supTitle="Sales" title="Sales" description="Sales" image={"/images/app.png"}/>
          <GridCard2 ClassName='lg:col-span-2 col-span-4 lg:rounded-bl-3xl' rounded='lg:rounded-bl-3xl' supTitle="Sales" title="Sales" description="Sales" image={"/images/app.png"}/>
          <GridCard2 ClassName='col-span-4 lg:rounded-br-3xl' rounded='lg:rounded-br-3xl' supTitle="Sales" title="Sales" description="Sales" image={"/images/app.png"}/>
      ...
      <section className='h-full w-full flex flex-col items-center justify-center mt-32 p-6 mb-32'>
        ...
        <div className='flex flex-col max-w-[1240px] items-start h-full w-full space-y-4'>
